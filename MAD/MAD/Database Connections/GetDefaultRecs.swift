...
class GetDefaultRecs: NSObject {
    
    
    
    weak var delegate: DownloadProtocol!
    
    let urlPath = "http://www.the-library-database.com/hhs_php/get_recs.php"
    ...
    func downloadItems() {
        ...
        let postString = "password=secureAf"
    ...
    func parseJSON(_ data:Data) {
        ...
        DispatchQueue.main.async(execute: { () -> Void in
            ...
            self.delegate.itemsDownloaded(items: books, from: "GetDefaultRecs")
