...
if ($_POST[password] == "1234")
{
	...
	if (!isset($_POST[isbn])) {
		...
		$int =$_POST[isbn];
		// This SQL statement selects ALL from the table 'Holds' matching a book isbn and organizes the results from earliest to most recent
		$sql = "SELECT * FROM Holds WHERE isbn={$int} ORDER BY timestart";
